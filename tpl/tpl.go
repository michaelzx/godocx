...
const (
	...
	DOCPROPS_APP  = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>Go DOCX</Application></Properties>`
	...
	WORD_STYLE = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
	...
	WORD_THEME_THEME = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
